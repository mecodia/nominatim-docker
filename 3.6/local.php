<?php
 ...
 @define('CONST_Database_DSN', 'pgsql:host=db;port=6432;user=nominatim;password=password1234;dbname=nominatim'); // <driver>:host=<host>;port=<port>;user=<username>;password=<password>;dbname=<database>
