<?php
 ...
 @define('CONST_Replication_Url', 'http://download.geofabrik.de/europe/dach-updates/');
 ...
 @define('CONST_Database_DSN', 'pgsql:host=db;port=5432;user=nominatim;password=nominatim;dbname=nominatim'); // <driver>:host=<host>;port=<port>;user=<username>;password=<password>;dbname=<database>
